...
class Structuring_Markup_Type_LocalBusiness {
	...
	private $social_array = array(
		...
		array("type" => "yelp",    	  "display" => "Yelp"),
		array("type" => "tripadvisor","display" => "TripAdvisor")
	);
	...
	private function page_render ( array $option ) {
		...
		$html .= $this->set_form_text( 'logo', 'Logo', $option['logo'], false, 'Default : bloginfo("logo") + "/images/logo.png"' );
		$html .= '</table>';
		echo $html;
